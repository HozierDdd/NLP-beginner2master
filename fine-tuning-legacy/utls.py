...
class Utils:
    ...
    def data_warnings_and_token_counts(self):
        ...
        Total Tokens Per Example: Calculates and summarizes the distribution of the total number of tokens in each conversation. Important for understanding fine-tuning-legacy costs.
        ...
        Token Limit Warnings: Checks if any examples exceed the maximum token limit (16,385 tokens), as such examples will be truncated during fine-tuning-legacy, potentially resulting in data loss."""
        n_missing_system = 0
        n_missing_user = 0
        n_messages = []
        ...
        print(f"\n{n_too_long} examples may be over the 16,385 token limit, they will be truncated during fine-tuning-legacy")
    ...
    #     # List 10 fine-tuning-legacy jobs
    ...
    #
    #     # List up to 10 events from a fine-tuning-legacy job
